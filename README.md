...
* Principales fonctionnalités de l'application (autres dans la description du projet 10):
  ...
  - Permissions;Il est interdit à tout utilisateur autorisé autre que l'auteur d'émettre des requêtes d'actualisation et de suppression d'un **_problème/projet/commentaire_**.
...
- A JSON view of your API specification at **_[/swagger.json]()_**
